...
def test_calculate_rad_velocity_cost():
    ...
    3D.retrieval.angles.add_azimuth_as_field(Grid, dz_name='zero_field')
    3D.retrieval.angles.add_elevation_as_field(Grid, dz_name='zero_field')
    ...
    cost = 3D.cost_functions.calculate_radial_vel_cost_function(
        vrs, azs, els, u, v, w, wts, rmsVr, weights)
    grad = 3D.cost_functions.calculate_grad_radial_vel(
...
def test_calculate_fall_speed():
    ...
    fall_speed = 3D.cost_functions.calculate_fall_speed(
...
def test_calculate_mass_continuity():
    ...
    cost = 3D.cost_functions.calculate_mass_continuity(
        u, v, w, z, dx, dy, dz)
    cost_grad = 3D.cost_functions.calculate_mass_continuity_gradient(
        u, v, w, z, dx, dy, dz)
...
def test_calculate_smoothness_cost():
    ...
    cost = 3D.cost_functions.calculate_smoothness_cost(
        u, v, w)
    cost_grad = 3D.cost_functions.calculate_smoothness_gradient(
        u, v, w)
...
def test_background_cost():
    ...
    cost = 3D.cost_functions.calculate_background_cost(
        u, v, w, weights, u_back, v_back)
    grad = 3D.cost_functions.calculate_background_gradient(
        u, v, w, weights, u_back, v_back)
...
def test_vert_vorticity():
    ...
    z = np.arange(0, 1000.0, 100)
    cost = 3D.cost_functions.calculate_vertical_vorticity_cost(
        u, v, w, dx, dy, dz, 10, 10)
    cost_grad = 3D.cost_functions.calculate_vertical_vorticity_gradient(
        u, v, w, dx, dy, dz, 10, 10)
...
def test_point_cost():
    ...
    cost = 3D.cost_functions.calculate_point_cost(u, v, x, y, z, [my_point1], roi=2.0)
    grad = 3D.cost_functions.calculate_point_gradient(u, v, x, y, z, [my_point1], roi=2.0)
    ...
    cost = 3D.cost_functions.calculate_point_cost(u, v, x, y, z, [my_point1, my_point2], roi=2.0)
    grad = 3D.cost_functions.calculate_point_gradient(u, v, x, y, z, [my_point1, my_point2], roi=2.0)
    assert cost > 0
    assert ~np.all(grad >= 0)
...
def test_model_cost():
    ...
    cost = 3D.cost_functions.calculate_model_cost(
        u, v, w, weights, u, v, w)
    cost_grad = 3D.cost_functions.calculate_model_gradient(
        u, v, w, weights, u, v, w)
    ...
    cost1 = 3D.cost_functions.calculate_model_cost(
        u, v, w, weights, u - 1, v, w)
    cost2 = 3D.cost_functions.calculate_model_cost(
