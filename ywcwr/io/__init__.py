...
from .grid_io import write_grid, read_grid
from .cfradial import write_cfradial, read_cfradial

__all__ = ["read_auto", "CCFile", "SCFile",
           "WSR98DFile", "SABFile",
           "write_grid", "read_grid", "write_cfradial", "read_cfradial"]

def read_auto(filename, station_lon=None, station_lat=None, station_alt=None, id=None, isfile=False):
    """
    ...
    radar_type = radar_format(filename, id=id, isfile=isfile)
    # print(1, radar_type)
