...
class SAB2NRadar(object):
    ...
    def __init__(self, SAB):
        self.SAB = SAB
        self.product_types = self.SAB.product_type
    ...
    def ToPRD(self):
        ...
        return PRD(fields=self.fields, scan_type=self.scan_type, time=self.get_scan_time(), \
                          ...
                          nrays=self.nrays, nsweeps=self.nsweeps, sitename=self.sitename, products=self.product_types, pyart_radar=self.ToPyartRadar())
