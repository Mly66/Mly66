...
class CCBaseData(object):
    ...
    def __init__(self, filename, station_lon=None, station_lat=None, station_alt=None):
        ...
        self.sitecode = self.header['ObsParam1']['cStationNumber'].decode('latin1')[:5]
    ...
    def get_sitename(self, id=False):
        return get_radar_sitename(self.filename, self.sitecode, id=id)
...
class CC2NRadar(object):
    ...
    def __init__(self, CC):
        ...
        self.product_types = self.CC.product_type
        ...
        self.range_v = self.get_range_per_radial(self.max_bins)
        self.range_z = self.get_range_per_radial(self.max_bins)
        # self.range = self.get_range_per_radial(self.max_bins)
        self.fields = self._get_fields()
        self.sitecode = self.CC.sitecode
        self.sitename = self.CC.get_sitename(id=True)
